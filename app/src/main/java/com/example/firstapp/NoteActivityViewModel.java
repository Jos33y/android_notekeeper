...
public class NoteActivityViewModel extends ViewModel {
    ...
    public static final String ORIGINAL_NOTE_TITLE = "com.example.firstapp.ORIGINAL_NOTE_TITLE";
    public static final String ORIGINAL_NOTE_TEXT = "com.example.firstapp.ORIGINAL_NOTE_TEXT";
